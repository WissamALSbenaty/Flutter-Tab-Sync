...
class LabeledTabSyncView<T> extends StatefulWidget {
  ...
  const LabeledTabSyncView({super.key, required this.items, this.itemsSpacing,this.spacer,
    required this.tabBuilder, required this.itemBuilder,  this.bodyPadding,
    this.tabBarPadding, required this.labelStyle,this.tabsSpacing=8,
    this.barHeight=32,});
...
class _LabeledTabSyncViewState<T> extends State<LabeledTabSyncView<T>> {
  ...
  Widget build(final BuildContext context) {
    return ValueListenableBuilder<int>(
        ...
        builder: (final _, final value,final __) => Column(
